...
## *Figure XX & XX*
#B) A bubble plot showing the number of effect sizes of each pharmaceutical_class_class class per immune trait
...
immune_pharmaceutical_class_bubble_plot <- pc_cb_summary_filtered %>%
   ggplot(aes(
       x = fct_rev(fct_reorder(str_wrap(str_to_title(immune_category_high), width = 15), n, .fun = 'sum')),
...
main_text_figure_1 <- immune_pharmaceutical_class_bubble_plot / species_effect_size_count_bar_plot
