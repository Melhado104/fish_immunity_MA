...
ggsave(here("figures", "figure_immune_pharma_bubble.pdf"), width = 12, height = 7, units = "cm", scale = 2, dpi = 800)
ggsave(here("figures", "figure_immune_pharma_bubble.jpg"), width = 12, height = 7, units = "cm", scale = 2, dpi = 800)
...
ggsave(filename = here::here("figures", "Figures_summary_family.pdf"), plot = family_effect_size_count_bar_plot, device = cairo_pdf, width = 120, height = 70, units = "mm", scale = 2, dpi = 800)

ggsave(filename = here::here("figures", "Figures_summary_family.jpg"), plot = family_effect_size_count_bar_plot, width = 120, height = 70, units = "mm", scale = 2, dpi = 800)
```
...
ggsave(filename = here::here("figures", "Figures_summary_immune.pdf"), plot = immune_effect_size_count_bar_plot, device = cairo_pdf, width = 120, height = 70, units = "mm", scale = 2, dpi = 800)

ggsave(filename = here::here("figures", "Figures_summary_immune.jpg"), plot = immune_effect_size_count_bar_plot, width = 120, height = 70, units = "mm", scale = 2, dpi = 800)
