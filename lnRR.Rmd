...
```{r}
### Question: Does pharmaceutical impact the immunocompetence of fish?
...
```{r}
#### Question: What is the mean effect of pharmaceutical exposure on each major immune category?
