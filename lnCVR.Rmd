...
lnCVRVCV <- metafor::vcalc(vi      = lnCVRv,
                           cluster = exposure_id,
                           obs     = assay_id,
                           data    = data,
                           rho     = 0.5)
...
# Summary statistics
summary(lnCVR_immune)
```

```{r}
lnCVR_pharma <- rma.mv(yi = lnCVR,
                                        V = lnCVRVCV,
                                        random = list(~1 | study_id,
                                            ~1 | assay_id,
                                            ~1 | pharmaceutical_class,
...
# Summary results
summary(lnCVR_pharma)

```

```{r}
lnCVR_phylogeny <- rma.mv(yi = lnCVR,
                               V = lnCVRVCV,
                               random = list(~1 | study_id,
                                            ~1 | assay_id,
                                            ~1 | pharmaceutical_class,
...
# Summary results
summary(lnCVR_phylogeny)

```

```{r}
lnCVR_sex <- rma.mv(yi = lnCVR,
                           V = lnCVRVCV,
                           random = list(~1 | study_id,
                                            ~1 | assay_id,
                                            ~1 | pharmaceutical_class,
