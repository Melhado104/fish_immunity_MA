...
ggsave(filename = here::here("figures", "Figure_overall_lnRR_lnVR.pdf"), plot = figure1_combined, device = cairo_pdf, width = 180, height = 70, units = "mm", scale = 2, dpi = 800)
ggsave(filename = here::here("figures", "Figure_overall_lnRR_lnVR.jpg"), plot = figure1_combined, width = 180, height = 70, units = "mm", scale = 2, dpi = 800)
...
ggsave(filename = here::here("figures", "Figure_immune_lnRR_lnVR.pdf"), plot = figure3_AB, device = cairo_pdf, width = 180, height = 70, units = "mm", scale = 2, dpi = 800)

ggsave(filename = here::here("figures", "Figure_immune_lnRR_lnVR.jpg"), plot = figure3_AB, width = 180, height = 70, units = "mm", scale = 2, dpi = 800)
```
...
ggsave(filename = here::here("figures", "Figure4_pharma_lnRR_lnVR.pdf"), plot = figure4_AB, device = cairo_pdf, width = 180, height = 70, units = "mm", scale = 2, dpi = 800)

ggsave(filename = here::here("figures", "Figure4_pharma_lnRR_lnVR.jpg"), plot = figure4_AB, width = 180, height = 70, units = "mm", scale = 2, dpi = 800)
